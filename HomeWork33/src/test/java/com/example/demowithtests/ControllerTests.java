...
public class ControllerTests {
    ...
    public void createPassTest() throws Exception {
        ...
        when(employeeConverter.employeeToEmployeeDto(any(Employee.class))).thenReturn(response);
        when(employeeConverter.employeeDtoToEmployee(any(EmployeeDto.class))).thenReturn(employee);
